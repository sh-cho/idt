...
impl ParsedId for ParsedUlid {
    ...
    fn inspect(&self) -> InspectionResult {
        ...
        let timestamp = self.timestamp().expect("ULID always has a timestamp");
        ...
        InspectionResult {
            ...
            encodings: IdEncodings {
                ...
                int: Some(u128::from_be_bytes(bytes.try_into().expect("ULID is 128-bit (16 bytes)")).to_string()),
            },
        }
    }
    ...
    fn encode(&self, format: EncodingFormat) -> String {
        ...
        match format {
            ...
            EncodingFormat::Int => u128::from_be_bytes(bytes.try_into().expect("ULID is 128-bit (16 bytes)")).to_string(),
