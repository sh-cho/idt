...
pub enum IdKind {
    #[cfg_attr(feature = "cli", value(name = "uuid"))]
    Uuid,
    #[cfg_attr(feature = "cli", value(name = "uuidv1", alias = "uuid-v1", alias = "uuid1"))]
    UuidV1,
    #[cfg_attr(feature = "cli", value(name = "uuidv3", alias = "uuid-v3", alias = "uuid3"))]
    UuidV3,
    #[cfg_attr(feature = "cli", value(name = "uuidv4", alias = "uuid-v4", alias = "uuid4"))]
    UuidV4,
    #[cfg_attr(feature = "cli", value(name = "uuidv5", alias = "uuid-v5", alias = "uuid5"))]
    UuidV5,
    #[cfg_attr(feature = "cli", value(name = "uuidv6", alias = "uuid-v6", alias = "uuid6"))]
    UuidV6,
    #[cfg_attr(feature = "cli", value(name = "uuidv7", alias = "uuid-v7", alias = "uuid7"))]
    UuidV7,
    #[cfg_attr(feature = "cli", value(name = "uuid-nil", alias = "uuidnil", alias = "nil"))]
    UuidNil,
    #[cfg_attr(feature = "cli", value(name = "uuid-max", alias = "uuidmax", alias = "max"))]
    UuidMax,
    #[cfg_attr(feature = "cli", value(name = "ulid"))]
    Ulid,
    #[cfg_attr(feature = "cli", value(name = "nanoid", alias = "nano"))]
    NanoId,
    #[cfg_attr(feature = "cli", value(name = "ksuid"))]
    Ksuid,
    #[cfg_attr(feature = "cli", value(name = "snowflake", alias = "snow"))]
    Snowflake,
    #[cfg_attr(feature = "cli", value(name = "objectid", alias = "oid", alias = "mongoid"))]
    ObjectId,
    #[cfg_attr(feature = "cli", value(name = "typeid"))]
    TypeId,
    #[cfg_attr(feature = "cli", value(name = "xid"))]
    Xid,
    #[cfg_attr(feature = "cli", value(name = "cuid"))]
    Cuid,
    #[cfg_attr(feature = "cli", value(name = "cuid2"))]
    Cuid2,
    #[cfg_attr(feature = "cli", value(name = "tsid"))]
    Tsid,
}
